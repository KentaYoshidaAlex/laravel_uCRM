...
import BreezeValidationErrors from '@/Components/Validations.vue'
import { Core as YubinbangoCore } from "yubinbango-core2";


const form = reactive({
    name: null, kana: null, tel: null, 
    email: null, postcode: null, address: null, 
                            ...
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="radio" id="gender0" name="genter" v-model="form.gender" value="0" >
                                        <label for="gender0" class="ml-2 mr-4">男性</label>
                                        <input type="radio" id="gender1" name="genter" v-model="form.gender" value="1" >
                                        <label for="gender1" class="ml-2 mr-4">女性</label>
                                        <input type="radio" id="gender2" name="genter" v-model="form.gender" value="2" >
